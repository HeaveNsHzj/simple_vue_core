...
/***/ function(module, exports, __webpack_require__) {
	...
	var compiledTpl = _vue2.default.compile(tpl);
	var options = Object.assign({
	  el: '#demo',
	  data: data
	}, compiledTpl);
	window.vm = new _vm.Vue(options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dep = __webpack_require__(12);
	  ...
	  Object.defineProperty(obj, key, {
	    ...
	    get: function get() {
	      if (_dep.Dep.target) {
	        ...
	        if (childOb) {
	          childOb.dep.addSub(_dep.Dep.target);
	        }
	      }
	      return value;
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vDom = __webpack_require__(15);

	var _watcher = __webpack_require__(13);

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var Vue = exports.Vue = function () {
	  ...
	  _createClass(Vue, [{
	    ...
	    value: function _init() {
	      ...
	      this._watcher = new _watcher.Watcher(this, function () {
	    ...
	    value: function _render() {
	      return this.$options.render.call(this, _vDom.createElement);
	    }
	    /* 执行dom更新m*/
	    ...
	    value: function _update(vnode) {
	      ...
	      this._vnode = vnode;
	      if (!prevNode) {
	        this.$el = (0, _vDom.patch)(this.$el, vnode);
	      } else {
	        this.$el = (0, _vDom.patch)(prevNode, vnode);
	      }
	...
	Vue.prototype._h = _vDom.createElement;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.patch = exports.createElement = undefined;
	...
	var _attributes = __webpack_require__(23);

	var _attributes2 = _interopRequireDefault(_attributes);

	var _eventlisteners = __webpack_require__(24);
	...
	var _h = __webpack_require__(27);

	var _h2 = _interopRequireDefault(_h);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var createElement = exports.createElement = _h2.default;
	var patch = exports.patch = (0, _snabbdom.init)([_attributes2.default, _class2.default, _style2.default, _props2.default, _eventlisteners2.default, _dataset2.default, _hero2.default]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var domApi = __webpack_require__(19);
